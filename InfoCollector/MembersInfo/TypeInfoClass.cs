...
{
    public class TypeInfoClass : BaseInfoClass, Member
    {
        public string Name { get; set; }

        public TypeInfoClass(Type info)
        {
            Name = GetTypeDeclaration(info);
        }

        private string GetTypeDeclaration(Type typeInfo)
        {
